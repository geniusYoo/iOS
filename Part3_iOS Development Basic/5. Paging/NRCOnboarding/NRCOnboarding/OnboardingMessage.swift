...
extension OnboardingMessage {
    static let messages: [OnboardingMessage] = [
        ...
        OnboardingMessage(imageName: "image1", title: "I LOVE THIS PICTURE", description: "You're first race, last mile, or push out the door whatever your pace, distance or need, we've got the playlist to match"),
    ]
